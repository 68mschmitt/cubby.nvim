...
function M.register()
    ...
    vim.api.nvim_create_user_command("ListInbox", function(opts)
        ...
        require("cubby.note").list_inbox(args)
    end, {
        nargs = "*",
